  ...
  return (
    <>
      <section 
        id="download" 
        ref={sectionRef}
        className="pt-32 pb-32 bg-gradient-to-r from-green-500 to-emerald-500 text-white relative overflow-hidden"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 pt-16 pb-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            {/* App Store Button */}
             <a href="https://play.google.com/store/search?q=gorkha%20ride&c=apps&hl=en" target='_blank'>
            <button 
