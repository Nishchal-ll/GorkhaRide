    ...
    <section id="expert-services" className="py-20 bg-white overflow-hidden relative " ref={sectionRef}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-12">
        ...
        <div 
          ...
          className={`text-center mb-16 transform transition-all duration-1000 animate-breathe ${
        ...
        <div 
          ...
          className={`bg-white rounded-2xl shadow-lg p-8 border border-green-100 transform transition-all duration-1000 animate-section-glow ${
            scrollAnimations.howItWorks ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-10 opacity-0 scale-95'
          }`}
        >
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <h3 className={`text-2xl font-bold text-dark mb-4 animate-heading-pulse transform transition-all duration-800 ${
              ...
              <div className="space-y-4">
                {steps.map((step, index) => (
                  ...
                  >
                    ...
                    <p className="text-dark animate-text-typing">{step.description}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="md:w-1/2 md:pl-10">
              <div 
                ...
                className={`rounded-xl p-6 border border-green-100 transform transition-all duration-1000 animate-benefits-container ${
              ...
              >
                ...
                <ul className="space-y-3">
                  {benefits.map((benefit, index) => (
                    ...
                    >
                      <CheckCircle className="w-5 h-5 text-dark mr-3 flex-shrink-0 transform transition-all duration-300 hover:scale-110 animate-check-pulse" />
                      <span className="text-dark animate-text-reveal">{benefit}</span>
                    </li>
                  ))}
                </ul>
