                    ...
                    <div className="flex items-center justify-between h-28">
                        ...
                        <a href="/" className="flex items-center pl-20">
                            ...
                            <div className="flex flex-col">
                                <span className="text-green-600 font-bold text-xl tracking-wider">GorkhaRide</span>
                                <span className="text-gray-500 text-xs tracking-wide">Your Partner</span>
                            </div>
                        </a>
                        ...
                        <div className="hidden lg:flex items-center justify-end">
                            ...
                            <ul className="flex items-center">
                                <li className="text-center">
                                    <a href="/account/login/" className="flex items-center space-x-2 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-6 py-2.5 rounded-full font-semibold text-sm transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                                        <Download size={18} />
                        ...
                        <div className="bg-white border-t border-gray-100 shadow-lg">
                            <ul className="px-4 py-3 space-y-1">
                                ...
                                <li className="pt-4 pb-2">
                                    <a href="/account/login/" className="w-full flex items-center justify-center space-x-2 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-6 py-3 rounded-full font-semibold transition-all duration-300 shadow-lg">
                                        <Download size={18} />
                                        <span>Download Now</span>
                                    </a>
                                </li>
